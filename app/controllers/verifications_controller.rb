class VerificationsController < ApplicationController
  ...
  private
    ...
    def verification_params
      params.require(:verification).permit({verification_photos_attributes: [:id, :url, :date_and_time, :latitude, :longitude, :_destroy]}, :user_id, :project_activity_obra_id, :answer, :evaluation, :comments, :status)
    end
end
