class CatPprParPartidaEspecificasController < ApplicationController
  ...
  def index
    @cat_ppr_par_partida_especificas = indexize(CatPprParPartidaEspecifica)
  end
