...
KeyMetaSubcategory.seed_once(:name) do |kms|
  ...
  kms.key_meta_category_id = KeyMetaCategory.find_by_name 'Centro Gestor'
end

KeyMetaSubcategory.seed_once(:name) do |kms|
  kms.name = 'Casificación Funcional'
  kms.key_meta_category_id = KeyMetaCategory.find_by_name 'Área Funcional'
end
KeyMetaSubcategory.seed_once(:name) do |kms|
  kms.name = 'ER'
  kms.key_meta_category_id = KeyMetaCategory.find_by_name 'Área Funcional'
...
KeyMetaSubcategory.seed_once(:name) do |kms|
  kms.name = 'Fondo'
  kms.key_meta_category_id = KeyMetaCategory.find_by_name 'Estructura Económica'
end
KeyMetaSubcategory.seed_once(:name) do |kms|
