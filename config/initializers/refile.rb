...
if Rails.env.production? && Admin::Settings['REFILE_USE_S3'] == 'true'
  ...
  Refile.backends['s3_backend'] = Refile::S3.new(prefix: "store_financial_documents", max_size: Admin::Settings['REFILE_S3_MAX_FILESIZE'].to_i.megabytes, **aws)
  Refile.backends['s3_cache'] = Refile::S3.new(prefix: "cache_financial_documents", max_size: Admin::Settings['REFILE_S3_MAX_FILESIZE'].to_i.megabytes, **aws)
